...
export function DmesgTimestampModal({ onClose }: DmesgTimestampModalProps) {
  return (
    <Modal onClose={onClose} title="dmesg Timestamp Format Detected" maxWidth="max-w-lg">
      <div className="space-y-4">
        ...
        <div className="p-3 bg-gray-100 dark:bg-gray-700 rounded-lg font-mono text-sm text-gray-800 dark:text-gray-200 overflow-x-auto">
          [4203828.436896] nf_conntrack: table full, dropping packet
        </div>
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          The <code className="px-1 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">-T</code> flag converts timestamps to human-readable format (e.g., "Mon Jan 13 10:30:45 2025").
        </p>
