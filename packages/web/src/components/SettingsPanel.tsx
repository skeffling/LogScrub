      ...
      <div className="flex-1 overflow-y-auto p-4 min-h-0">
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300 block mb-2">Theme</span>
            ...
            <label className="flex items-center justify-between gap-3 p-3 bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700">
              <div>
                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Terminal Style</span>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Dark grey background with light text for Original and Scrubbed panes</p>
              </div>
              <input
                type="checkbox"
