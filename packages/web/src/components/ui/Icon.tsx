...
const icons: Record<IconName, (props: { className: string }) => JSX.Element> = {
  ...
  'unlink': ({ className }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101M3 3l18 18m-3.828-10.172a4 4 0 015.656 0l4 4a4 4 0 01-5.656 5.656l-1.1-1.1" />
    </svg>
  ),
  ...
  'fullscreen-exit': ({ className }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 9V4m0 5H4m0 0l5-5m5 15v-5m0 5h5m0 0l-5-5M9 15v5m0-5H4m0 0l5 5m5-15V4m0 5h5m0 0l-5-5" />
    </svg>
  ),
  'clock': ({ className }) => (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const Icon = memo(function Icon({ name, size = 'md', className = '', title }: IconProps) {
